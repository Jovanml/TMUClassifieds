...
const NewListing = () => {
    ...
    const formComponents = {
        ...
        4: <AddPrice price={price} setPrice={setPrice}/>
    }
        ...
        <Box height='100vh'>
            <Container>
                ...
                <Box display='flex' justifyContent='space-between' mt='20px' height='45px'>
                    ...
                    sx={{ display: currentStep !== 4 ? 'default' : 'none' }} onClick={nextStep}>Next</Button>
                    <Button variant='contained' backgroundcolor='black' sx={{ display: currentStep === 4 ? 'default' : 'none' }} 
